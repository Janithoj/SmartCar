...
<div class="detailed_inputs" style=" background: #6581ca;">
        <div>
		<h3>Full Name<span class="small">your full name</span></h3>
		<input type="text" name="data[User][full_name]" value="<?=$user_info['User']['full_name'];?>"/>
	</div>
	<div>
