...
class TagsController extends AppController {
    ...
    var $name = 'Tags';
    var $uses = array('Tag', 'Question', 'Setting');
    var $components = array('RequestHandler');
    var $helpers = array('Form', 'Time', 'Html', 'Javascript','Session','Thumbnail');
    ...
    public function find_tag($tag_name='Paint', $page=1) {
        ...
        $result_count = count($dummy['0']['Question']);
